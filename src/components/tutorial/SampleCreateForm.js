                      ...
                      <div className="mega-input-child-container">
                        <div className="input-mega-div">
                          ...
                          >
                            ...
                            <option value="">None</option>
                            {
                              otherVersions.findIndex(pkmn => pkmn.name === creature.firstCreature.toLowerCase())
                                .versions
                                .map(version => {
                                  return (
                      ...
                      <div className="mega-input-child-container">
                        <div className="input-mega-div">
                          ...
                          >
                            ...
                            <option value="">None</option>
                            {
                              otherVersions.findIndex(pkmn => pkmn.name === creature.secondCreature.toLowerCase())
                                .versions
                                .map(version => {
                                  return (
                                    <option value={version.value}>{version.text}</option>
                      ...
                      <div className="mega-input-child-container">
                        <div className="input-mega-div">
                          ...
                          >
                            ...
                            <option value="">None</option>
                            {
                              otherVersions.findIndex(pkmn => pkmn.name === creature.thirdCreature.toLowerCase())
                                .versions
                                .map(version => {
                                  return (
                                    <option value={version.value}>{version.text}</option>
                      ...
                      <div className="mega-input-child-container">
                        <div className="input-mega-div">
                          ...
                          >
                            ...
                            <option value="">None</option>
                            {
                              otherVersions.findIndex(pkmn => pkmn.name === creature.fourthCreature.toLowerCase())
                                .versions
                                .map(version => {
                                  return (
                                    <option value={version.value}>{version.text}</option>
